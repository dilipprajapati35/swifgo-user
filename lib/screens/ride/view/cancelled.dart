...
import 'package:flutter_arch/screens/ride/view/myridesCancelled.dart';
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => Myridescancelled(),
          ),
        );
      },
      child: Column(
  ...
  Widget _buildTopRow(RideModel ride) {
    return Row(
      ...
      children: [
        Text(
          'Manual',
          style: GoogleFonts.nunito(fontSize: 13, color: Color(0xfff364B63)),
        ),
        Container(
          width: 5,
          height: 5,
